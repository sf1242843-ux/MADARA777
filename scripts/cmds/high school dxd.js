...
module.exports = {
  config: {
    ...
    countDown: 5,
    role: 2,
    shortDescription: "Watch Hentai High School DXD",
    longDescription: "List all Hentai High School DXD episodes and play selected one",
    category: "18+",
  ...
  onStart: async function ({ api, event }) {
    try {
      ...
      let msg = `🎬 Hentai High School DXD Episodes:\n\n`;
      const mapEp = [];
